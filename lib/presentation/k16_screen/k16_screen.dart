                                                                          ...
                                                                          Align(
                                                                              ...
                                                                              child: Container(
                                                                                  ...
                                                                                  child: Stack(alignment: Alignment.center, children: [
                                                                                    Align(alignment: Alignment.centerLeft, child: Container(height: getVerticalSize(161.00), width: getHorizontalSize(363.00), child: SvgPicture.asset(ImageConstant.imgFrame218, fit: BoxFit.fill))),
                                                                                    Align(
                                                                                        alignment: Alignment.center,
                                                                                        child: Padding(
                                                                ...
                                                                GestureDetector(
                                                                    ...
                                                                    child: Padding(
                                                                        ...
                                                                        child: Container(
                                                                            ...
                                                                            child: SvgPicture.asset(ImageConstant.imgAkariconscros8, fit: BoxFit.fill)))),
                                                                Align(
                                                                    alignment:
                                                                        Alignment
                                                                            .centerLeft,
                                                                ...
                                                                Align(
                                                                    ...
                                                                    child: Container(
                                                                        ...
                                                                        child: Stack(alignment: Alignment.center, children: [
                                                                          Align(
                                                                              alignment: Alignment.centerLeft,
                                                                              child: Container(height: getVerticalSize(674.00), width: getHorizontalSize(581.00), child: SvgPicture.asset(ImageConstant.imgEllipse412, fit: BoxFit.fill))),
                                                                          Align(
                                                                              alignment: Alignment.center,
                                                                              child: Container(
                                                                                  height: getVerticalSize(485.00),
                                                                                  ...
                                                                                  child: Stack(alignment: Alignment.topRight, children: [
                                                                                    Align(alignment: Alignment.centerLeft, child: Image.asset(ImageConstant.imgWhatsappimage25, height: getVerticalSize(485.00), width: getHorizontalSize(440.00), fit: BoxFit.fill)),
                                                                                    Align(alignment: Alignment.topRight, child: Padding(padding: EdgeInsets.only(left: getHorizontalSize(15.00), top: getVerticalSize(10.00), right: getHorizontalSize(15.00), bottom: getVerticalSize(10.00)), child: Container(height: getVerticalSize(47.00), width: getHorizontalSize(58.00), child: SvgPicture.asset(ImageConstant.imgVector37, fit: BoxFit.fill))))
                                                                                  ])))
                                                                        ])))
                                                              ])))
                                                ])))
