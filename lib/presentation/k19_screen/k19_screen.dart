                                                                          ...
                                                                          Align(
                                                                              ...
                                                                              child: Container(
                                                                                  ...
                                                                                  child: Stack(alignment: Alignment.center, children: [
                                                                                    Align(alignment: Alignment.centerLeft, child: Container(height: getVerticalSize(161.00), width: getHorizontalSize(363.00), child: SvgPicture.asset(ImageConstant.imgFrame2111, fit: BoxFit.fill))),
                                                                                    Align(
                                                                                        alignment: Alignment.center,
                                                                                        child: Padding(
                                                                ...
                                                                GestureDetector(
                                                                    ...
                                                                    child: Padding(
                                                                        ...
                                                                        child: Container(
                                                                            ...
                                                                            child: SvgPicture.asset(ImageConstant.imgAkariconscros11, fit: BoxFit.fill)))),
                                                                Align(
                                                                    alignment:
                                                                        Alignment
                                                                            .centerLeft,
                                                                ...
                                                                Align(
                                                                    ...
                                                                    child: Container(
                                                                        ...
                                                                        child: Stack(alignment: Alignment.topCenter, children: [
                                                                          Align(
                                                                              alignment: Alignment.centerLeft,
                                                                              child: Container(height: getVerticalSize(674.00), width: getHorizontalSize(581.00), child: SvgPicture.asset(ImageConstant.imgEllipse415, fit: BoxFit.fill))),
                                                                          Align(
                                                                              alignment: Alignment.topCenter,
                                                                              child: Container(
                                                                                  height: getVerticalSize(505.00),
                                                                                  width: getHorizontalSize(425.00),
                                                                                  margin: EdgeInsets.only(left: getHorizontalSize(76.00), top: getVerticalSize(63.00), right: getHorizontalSize(76.00), bottom: getVerticalSize(63.00)),
                                                                                  child: Stack(alignment: Alignment.topRight, children: [
                                                                                    Align(alignment: Alignment.centerLeft, child: Image.asset(ImageConstant.imgWhatsappimage31, height: getVerticalSize(505.00), width: getHorizontalSize(425.00), fit: BoxFit.fill)),
                                                                                    Align(alignment: Alignment.topRight, child: Padding(padding: EdgeInsets.only(left: getHorizontalSize(10.00), top: getVerticalSize(30.00), right: getHorizontalSize(6.00), bottom: getVerticalSize(30.00)), child: Container(height: getVerticalSize(47.00), width: getHorizontalSize(58.00), child: SvgPicture.asset(ImageConstant.imgVector40, fit: BoxFit.fill))))
                                                                                  ])))
                                                                        ])))
                                                              ])))
                                                ])))
