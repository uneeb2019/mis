                                                                        ...
                                                                        Align(
                                                                            ...
                                                                            child: Container(
                                                                                ...
                                                                                child: Stack(alignment: Alignment.center, children: [
                                                                                  Align(alignment: Alignment.centerLeft, child: Container(height: getVerticalSize(161.00), width: getHorizontalSize(363.00), child: SvgPicture.asset(ImageConstant.imgFrame212, fit: BoxFit.fill))),
                                                                                  Align(
                                                                                          ...
                                                                                          child: Row(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.max, children: [
                                                                                            ...
                                                                                            Container(
                                                                                                ...
                                                                                                child: Stack(alignment: Alignment.bottomCenter, children: [
                                                                                                  ...
                                                                                                  Align(alignment: Alignment.bottomCenter, child: Container(height: getVerticalSize(39.00), width: getHorizontalSize(43.00), margin: EdgeInsets.only(left: getHorizontalSize(19.00), top: getVerticalSize(17.00), right: getHorizontalSize(19.00), bottom: getVerticalSize(17.00)), decoration: BoxDecoration(color: ColorConstant.orange300, borderRadius: BorderRadius.circular(getHorizontalSize(19.50)), border: Border.all(color: ColorConstant.blue700, width: getHorizontalSize(6.00)))))
                                                                                                ])),
                                                                  ...
                                                                  child: Column(
                                                                      ...
                                                                      children: [
                                                                        Align(
                                                                            ...
                                                                            child: Padding(padding: EdgeInsets.only(left: getHorizontalSize(35.00), top: getVerticalSize(2.00), right: getHorizontalSize(35.00), bottom: getVerticalSize(62.00)), child: Text("lbl_vionic_shoe".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.textstylesansitaregular501.copyWith(fontSize: getFontSize(50)))))
                                                                      ]))),
                                                          Align(
                                                              alignment:
                                                                  Alignment
                                                                      ...
                                                                      children: [
                                                                        Align(
                                                                            ...
                                                                            child: Container(
                                                                                ...
                                                                                child: SvgPicture.asset(ImageConstant.imgEllipse46, fit: BoxFit.fill))),
                                                                        Align(
                                                                            alignment:
                                                                                Alignment.topCenter,
                                                                            child: Padding(
                                                                                padding: EdgeInsets.only(left: getHorizontalSize(36.00), top: getVerticalSize(93.00), right: getHorizontalSize(36.00), bottom: getVerticalSize(93.00)),
                                                                                child: Column(mainAxisSize: MainAxisSize.min, mainAxisAlignment: MainAxisAlignment.start, children: [
                                                                                  Align(alignment: Alignment.centerRight, child: Padding(padding: EdgeInsets.only(left: getHorizontalSize(45.00), right: getHorizontalSize(45.00)), child: Container(height: getVerticalSize(47.00), width: getHorizontalSize(58.00), child: SvgPicture.asset(ImageConstant.imgVector31, fit: BoxFit.fill)))),
                                                                                  Align(alignment: Alignment.centerLeft, child: Padding(padding: EdgeInsets.only(top: getVerticalSize(62.00)), child: Image.asset(ImageConstant.imgRectangle241, height: getVerticalSize(304.00), width: getHorizontalSize(504.00), fit: BoxFit.fill)))
                                                                                ])))
                                                                      ]))),
                                                          Align(
                                                              alignment: Alignment
