                                                                        ...
                                                                        Align(
                                                                            ...
                                                                            child: Container(
                                                                                ...
                                                                                child: Stack(alignment: Alignment.center, children: [
                                                                                  Align(alignment: Alignment.centerLeft, child: Container(height: getVerticalSize(161.00), width: getHorizontalSize(363.00), child: SvgPicture.asset(ImageConstant.imgFrame214, fit: BoxFit.fill))),
                                                                                  Align(
                                                                                          ...
                                                                                          child: Row(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.max, children: [
                                                                                            ...
                                                                                            Container(
                                                                                                ...
                                                                                                child: Stack(alignment: Alignment.bottomCenter, children: [
                                                                                                  ...
                                                                                                  Align(alignment: Alignment.bottomCenter, child: Container(height: getVerticalSize(39.00), width: getHorizontalSize(43.00), margin: EdgeInsets.only(left: getHorizontalSize(19.00), top: getVerticalSize(17.00), right: getHorizontalSize(19.00), bottom: getVerticalSize(17.00)), decoration: BoxDecoration(color: ColorConstant.pink100, borderRadius: BorderRadius.circular(getHorizontalSize(19.50)), border: Border.all(color: ColorConstant.purple200, width: getHorizontalSize(6.00)))))
                                                                                                ])),
                                                                                            Container(width: getHorizontalSize(103.00), margin: EdgeInsets.only(left: getHorizontalSize(16.00), top: getVerticalSize(2.00), bottom: getVerticalSize(16.00)), child: Text("lbl_price_2900_pkr".tr, maxLines: null, textAlign: TextAlign.left, style: AppStyle.textstylesansitaregular25.copyWith(fontSize: getFontSize(25))))
                                                                                          ])))
                                                                                ])))
                                                                      ]))),
                                                          Align(
                                                                  ...
                                                                  child: Column(
                                                                      ...
                                                                      children: [
                                                                        Align(
                                                                            ...
                                                                            child: Padding(padding: EdgeInsets.only(left: getHorizontalSize(49.00), right: getHorizontalSize(49.00), bottom: getVerticalSize(64.00)), child: Text("lbl_sneakers_uni".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.textstylesansitaregular501.copyWith(fontSize: getFontSize(50)))))
                                                                      ]))),
                                                          Align(
                                                              alignment:
                                                                  Alignment
                                                                      ...
                                                                      children: [
                                                                        Align(
                                                                            ...
                                                                            child: Container(
                                                                                ...
                                                                                child: SvgPicture.asset(ImageConstant.imgEllipse48, fit: BoxFit.fill))),
                                                                        Align(
                                                                            alignment:
                                                                                Alignment.topCenter,
                                                                            child: Padding(
                                                                                padding: EdgeInsets.only(left: getHorizontalSize(46.00), top: getVerticalSize(93.00), right: getHorizontalSize(46.00), bottom: getVerticalSize(93.00)),
                                                                                child: Column(mainAxisSize: MainAxisSize.min, mainAxisAlignment: MainAxisAlignment.start, children: [
                                                                                  Align(alignment: Alignment.centerRight, child: Padding(padding: EdgeInsets.only(left: getHorizontalSize(40.00), right: getHorizontalSize(40.00)), child: Container(height: getVerticalSize(47.00), width: getHorizontalSize(58.00), child: SvgPicture.asset(ImageConstant.imgVector33, fit: BoxFit.fill)))),
                                                                                  Align(alignment: Alignment.centerLeft, child: Padding(padding: EdgeInsets.only(top: getVerticalSize(27.00)), child: Image.asset(ImageConstant.imgWhatsappimage18, height: getVerticalSize(325.00), width: getHorizontalSize(489.00), fit: BoxFit.fill)))
                                                                                ])))
                                                                      ]))),
                                                          Align(
                                                              alignment: Alignment
