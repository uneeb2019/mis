                                                                        ...
                                                                        Align(
                                                                            ...
                                                                            child: Container(
                                                                                ...
                                                                                child: Stack(alignment: Alignment.center, children: [
                                                                                  Align(alignment: Alignment.centerLeft, child: Container(height: getVerticalSize(161.00), width: getHorizontalSize(363.00), child: SvgPicture.asset(ImageConstant.imgFrame21, fit: BoxFit.fill))),
                                                                                  Align(
                                                                  ...
                                                                  child: Column(
                                                                      ...
                                                                      children: [
                                                                        Align(
                                                                            ...
                                                                            child: Padding(padding: EdgeInsets.only(left: getHorizontalSize(36.00), right: getHorizontalSize(36.00), bottom: getVerticalSize(62.00)), child: Text("msg_alexander_mcque".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.textstylesansitaregular501.copyWith(fontSize: getFontSize(50)))))
                                                                      ]))),
                                                          Align(
                                                              alignment:
                                                                  Alignment
                                                                      ...
                                                                      children: [
                                                                        Align(
                                                                            ...
                                                                            child: Container(
                                                                                ...
                                                                                child: SvgPicture.asset(ImageConstant.imgEllipse4, fit: BoxFit.fill))),
                                                                        Align(
                                                                            alignment:
                                                                                Alignment.topCenter,
                                                                            child: Padding(
                                                                                padding: EdgeInsets.only(left: getHorizontalSize(39.00), top: getVerticalSize(93.00), right: getHorizontalSize(39.00), bottom: getVerticalSize(93.00)),
                                                                                child: Column(mainAxisSize: MainAxisSize.min, mainAxisAlignment: MainAxisAlignment.start, children: [
                                                                                  Align(alignment: Alignment.centerRight, child: Padding(padding: EdgeInsets.only(left: getHorizontalSize(42.00), right: getHorizontalSize(42.00)), child: Container(height: getVerticalSize(47.00), width: getHorizontalSize(58.00), child: SvgPicture.asset(ImageConstant.imgVector19, fit: BoxFit.fill)))),
                                                                                  Align(alignment: Alignment.centerLeft, child: Padding(padding: EdgeInsets.only(top: getVerticalSize(71.00)), child: Image.asset(ImageConstant.imgRectangle26, height: getVerticalSize(305.00), width: getHorizontalSize(498.00), fit: BoxFit.fill)))
                                                                                ])))
                                                                      ]))),
                                                          Align(
                                                              alignment: Alignment
