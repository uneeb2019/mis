                                                                          ...
                                                                          Align(
                                                                              ...
                                                                              child: Container(
                                                                                  ...
                                                                                  child: Stack(alignment: Alignment.center, children: [
                                                                                    Align(alignment: Alignment.centerLeft, child: Container(height: getVerticalSize(161.00), width: getHorizontalSize(363.00), child: SvgPicture.asset(ImageConstant.imgFrame219, fit: BoxFit.fill))),
                                                                                    Align(
                                                                                        alignment: Alignment.center,
                                                                                        child: Padding(
                                                                ...
                                                                GestureDetector(
                                                                    ...
                                                                    child: Padding(
                                                                        ...
                                                                        child: Container(
                                                                            ...
                                                                            child: SvgPicture.asset(ImageConstant.imgAkariconscros9, fit: BoxFit.fill)))),
                                                                Align(
                                                                    alignment:
                                                                        Alignment
                                                                            .centerLeft,
                                                                ...
                                                                Align(
                                                                    ...
                                                                    child: Container(
                                                                        ...
                                                                        child: Stack(alignment: Alignment.center, children: [
                                                                          Align(
                                                                              alignment: Alignment.centerLeft,
                                                                              child: Container(height: getVerticalSize(674.00), width: getHorizontalSize(581.00), child: SvgPicture.asset(ImageConstant.imgEllipse413, fit: BoxFit.fill))),
                                                                          Align(
                                                                              alignment: Alignment.center,
                                                                              child: Container(
                                                                                  height: getVerticalSize(475.00),
                                                                                  width: getHorizontalSize(425.00),
                                                                                  margin: EdgeInsets.only(left: getHorizontalSize(40.00), top: getVerticalSize(40.00), right: getHorizontalSize(40.00), bottom: getVerticalSize(40.00)),
                                                                                  child: Stack(alignment: Alignment.topRight, children: [
                                                                                    Align(alignment: Alignment.bottomLeft, child: Padding(padding: EdgeInsets.only(top: getVerticalSize(10.00)), child: Image.asset(ImageConstant.imgWhatsappimage27, height: getVerticalSize(455.00), width: getHorizontalSize(425.00), fit: BoxFit.fill))),
                                                                                    Align(alignment: Alignment.topRight, child: Padding(padding: EdgeInsets.only(left: getHorizontalSize(10.00), right: getHorizontalSize(9.00), bottom: getVerticalSize(10.00)), child: Container(height: getVerticalSize(47.00), width: getHorizontalSize(58.00), child: SvgPicture.asset(ImageConstant.imgVector38, fit: BoxFit.fill))))
                                                                                  ])))
                                                                        ])))
                                                              ])))
                                                ])))
